...
{
    HumidityProvider(Context context)
    {
        _sensorManager = (SensorManager) context.getSystemService(Context.SENSOR_SERVICE);
        _humidity = _sensorManager.getDefaultSensor(Sensor.TYPE_RELATIVE_HUMIDITY);
    }

    @Override
    public boolean isAvailable()
    {
        return _humidity != null;
    }
    ...
    {
        return new Reading("Humidity", Double.valueOf(event.values[0]), "%");
    }

    private final SensorManager _sensorManager;
    private Sensor _humidity;
}
